...
const stopsBetweenStations = function (startLine, startStation, endLine, endStation) {
  ...
  // Add startStation to path. 'bestPath' array will contain all
  // stations along the shortest route to the destination, determined
  // by recursive 'findRoute()' function.
